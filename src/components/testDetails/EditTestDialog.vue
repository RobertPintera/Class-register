...
<template>
  <Dialog header="Edit test" v-model:visible="visible" :modal="true" :draggable="false" class="w-70">
    <Form v-slot="$form" :initialValues :resolver @submit="submit" class="flex flex-col gap-3 mt-2 w-full">
      ...
      <div class="flex flex-col gap-1">
        <FloatLabel variant="on">
          <InputNumber id="weight" name="weight" class="w-full" variant="filled" data-cy="weight-input" :min="0" :max="10000" :maxFractionDigits="1" :step="0.1"/>
      ...
      <div class="flex flex-col gap-1">
        <FloatLabel variant="on">
          <InputNumber id="requiredPoints" name="requiredPoints" class="w-full" variant="filled" data-cy="required-points-input" :min="0" :max="100" :maxFractionDigits="1" :step="0.1" :disabled="!$form.isRequired?.value"/>
